...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/scholarly-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14830&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/scholarly-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `scholarly` can be installed with:

```
conda install scholarly
```

It is possible to list all of the versions of `scholarly` available on your platform with:
